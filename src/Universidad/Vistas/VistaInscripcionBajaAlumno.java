...
public class VistaInscripcionBajaAlumno extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButtonInscripcion.setText("Dar de baja");
    ...
    private void jButtonVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerificarActionPerformed
        ...
        if(ok){
            JOptionPane.showMessageDialog(this,"El alumno puede darse de baja en la materia");
            jButtonInscripcion.setEnabled(true);
        }
        else{
            JOptionPane.showMessageDialog(this,"El alumno no se encuentra inscripto en la materia");
    ...
    private void jButtonInscripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInscripcionActionPerformed
        ...
        JOptionPane.showMessageDialog(this,"El alumno ha sido dado de baja en la materia");
        jButtonInscripcion.setEnabled(false);
